...
public final class AccessAsAppUser {
    ...
    public static void main(String[] args) throws IOException {
        ...
        BoxDeveloperEditionAPIConnection api = BoxDeveloperEditionAPIConnection.getAppUserConnection(USER_ID, app.CLIENT_ID,
                app.CLIENT_SECRET, encryptionPref, accessTokenCache);
