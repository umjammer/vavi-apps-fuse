 ...
 *
 * <p>
 * This class wraps a Commons VFS downloader class by extending {@code
 ...
 * try-with-resources statement (which the Commons VFS class isn't).
 * </p>
 *
 * <p>
 ...
 * VfsIOException}. If the underlying output stream <em>did</em> throw an
...
public final class VfsOutputStream extends OutputStream {
    ...
    public VfsOutputStream(FileSystemManager manager, @Nonnull final java.io.File file, String filename, Consumer<FileObject> consumer) throws IOException {
...
System.out.println("here: 2");
    ...
    public void close() throws IOException {
         ...
         * VfsIOException if the stream was OK. */

        try {
//System.out.println("close: " + uploader.getUploadFile().length());
            FileObject fileMetadata = null;

            consumer.accept(fileMetadata);
        } catch (Exception e) {
            if (exception == null)
                exception = new VfsIOException(e);
            else
