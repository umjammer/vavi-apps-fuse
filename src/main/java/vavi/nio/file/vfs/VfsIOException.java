...
/**
 * Class used as a wrapper over the Commons VFS API's unchecked exceptions when
 * an {@link IOException} is needed
 *
 * <p>
 * The problem mainly comes from {@link File} and {@link
 * FileObject}. Both of these methods define a {@code close()} method
 ...
 * @see VfsOutputStream
 */
public final class VfsIOException extends IOException {

    public static VfsIOException wrap(final Exception e) {
        return new VfsIOException("Commons VFS API error", e);
    }
     ...
     */
    public VfsIOException(final String message) {
        super(message);
    }
     ...
     * @since 1.6
     */
    public VfsIOException(final String message, final Throwable cause) {
        super(message, cause);
    }
     ...
     * @since 1.6
     */
    public VfsIOException(final Throwable cause) {
        super(cause);
    }
}
